...
const RegisterPage = () => {
  ...
  return (
    <div className="d-flex flex-column justify-content-center align-items-center min-vh-100 bg-dark py-5">
      <h3 className="text-white font-weight-bold mb-4 text-center w-100">Register</h3>
      <div className="card shadow-lg p-4 w-100" style={{ maxWidth: '1000px' }}>
        <div className="row">
          ...
          <div className="col-md-6 d-flex justify-content-center align-items-center">
            <img src={registerPicture} alt="Register" className="img-fluid rounded" style={{ maxWidth: '300px' }} />
          </div>
        </div>
      </div>
    </div>
